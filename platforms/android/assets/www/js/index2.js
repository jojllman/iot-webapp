...
$(document).on('pagebeforeshow', '#headline', function(){      
    ...
    $('#movie-data').append('<li><img src="http://d3gtl9l2a4fn1j.cloudfront.net/t/p/w185'+'row.poster_path'+'"></li>');
            $('#movie-data').append('<li>Title: '+'haha'+'</li>');
            $('#movie-data').append('<li>Release date'+'haha'+'</li>');
            $('#movie-data').append('<li>Popularity : '+'90'+'</li>');   
            $('#movie-data').append('<li>Popularity : '+'30.0'+'</li>');             
            $('#movie-data').listview('refresh');            
});
